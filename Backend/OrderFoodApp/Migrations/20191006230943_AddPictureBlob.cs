...
{
    public partial class AddPictureBlob : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureBlob = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetail", x => new { x.OrderId, x.FoodItemId });
                    table.UniqueConstraint("AK_OrderDetail_OrderId", x => x.OrderId);
                    table.ForeignKey(
